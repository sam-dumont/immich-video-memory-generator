...
if TYPE_CHECKING:
    from immich_memories.analysis.period_insight_material import EpisodeScanPack
...
# validation run).
EPISODE_SCAN_PROMPT_VERSION = "episode-scan-prompt-v5"
...
def _episode_prompt(pack: EpisodeScanPack) -> str:
    ...
    return (
        ...
        "episode's own tiles and sort them into four lists. notes: taken as a note rather than "
        "as a memory, such as a screen, a watch face or fitness display, or a document. "
        "failed: the picture did not come out, being obstructed, smeared, or "
        "unreadable. foreign: not a picture of this life at all -- stock or illustrative "
        "imagery, archival or instructional footage, media saved from elsewhere rather "
        "than taken by or of these people. ordinary: nothing wrong with it, just unremarkable or one of several "
        "alike. Most tiles are ordinary, and empty notes, failed and foreign lists are the normal "
