...
whole `up` over it. Use `cpuset: "0-3"` there instead, see [NAS](../common-setups/nas-only.md).
...
see [Immich API compatibility](../configuration/config-file.md#immich-api-compatibility).
...
[automated generation](../../create/recipes/automated-generation.md).
