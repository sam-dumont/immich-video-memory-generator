...
[the pipeline](../how-it-chooses/picking-shots.md). A video already prepared before this is sampled once more
...
a model is on [Rules mode](../how-it-chooses/what-a-model-adds.md), and what it
