...
3. **The standing gate rejects before the pick** (`editorial_story_carriers.StandingGate`) —
   ...
   measured after selection guide timing and do not change this question on a repeat. A moving
   clip needs at least one standing approval. Playing motion cannot override two weak votes, even
