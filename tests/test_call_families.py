...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("story-weighing-reversed-page-3", "story-weighing"),
        ("story-weighing-source-candidate-context", "story-weighing"),
        ("story-episodes-2030-02", "story-episodes"),
        ("story-episodes-2030-02-again-1", "story-episodes"),
