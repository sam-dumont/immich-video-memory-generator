...
After scene detection, each segment goes through [interest scoring](./clip-selection-scoring.md) to decide which ones make it into the final video. Scene detection just finds the boundaries; scoring decides the quality.
