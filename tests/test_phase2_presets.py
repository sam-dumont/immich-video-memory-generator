"""HOLIDAY was an enum member with nothing behind it."""
...
def test_multi_range_types_are_ordered_most_recent_first() -> None:
    ...
    That only works on a descending list: a builder that returned its windows
    oldest first once recorded a span of 2025-01-01 to 2017-12-31 — start after end.
    """
    from immich_memories.cli._date_resolution import resolve_date_range
    ...
    for kwargs in (
        ...
        {"memory_type": "on_this_day", "years_back": 3},
    ):
