...
Automation keys its proposal by the anniversary as well as the date (`special_day:2016-06-12:2016-06-12:10y`), so a day that got its memory at ten years can
