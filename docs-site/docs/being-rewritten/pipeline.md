...
This page is being split into the new docs. Its text moves to [From library to film](../how-it-chooses/overview.md), [Moments, episodes and stories](../how-it-chooses/moments-and-stories.md), [Picking each shot](../how-it-chooses/picking-shots.md), [Family, audience and duplicates](../how-it-chooses/family-audience-duplicates.md), [Length, quiet weeks and filler](../how-it-chooses/length-and-filler.md), [What a model adds](../how-it-chooses/what-a-model-adds.md), [Overrule it](../how-it-chooses/overrule-it.md), [Glossary](../how-it-chooses/glossary.md).
...
[special days catalogue](../make/cli/prepare.md#discover-days) is built by looking at what your days actually
...
newborn is not read as "unrelated to the main subject". In a film about a person, that person's
...
the story's worthiness, close family in the pictures (in a film about a person, theirs as well as
yours), motion, and how many pictures the no-model
...
whole library is what [`prepare`](../make/cli/prepare.md) is for.
The levers are putting the caption server and the reader where they are fast, preparing a library
ahead with [`prepare`](../make/cli/prepare.md), and keeping the cache. If the render is
...
write side, not the read side. See [Hardware acceleration](../run/hardware.md).
...
[What invalidates them](../run/maintenance/health-logs-cache.md#the-facts-a-cut-measures).
