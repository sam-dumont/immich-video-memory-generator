...
The commands and configuration are in [Local ACE-Step setup](../make/titles-maps-music.md#install-locally-on-a-mac).
The pinned
encoder, detector weights and caption endpoint the `editorial` runtime needs are on
[editorial annotation setup](../being-rewritten/editorial-preparation.md).
