...
ASSET_DESCRIPTION_PASS_NAME = "asset-description"  # noqa: S105 - editorial pass identity
...
def describe_editorial_assets(
    ...
    *,
    ...
    flat = sorted(chain.from_iterable(outcome_groups), key=lambda pair: order[pair[0]])
...
def _packed_request(
    ...
    *,
    ...
    return VisualEditorialRequest(
        pass_name=ASSET_DESCRIPTION_PASS_NAME,
        pass_version=(
