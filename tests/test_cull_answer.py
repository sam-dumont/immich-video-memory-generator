        ...
        json.dumps(
            {
                ...
                "pack": 1,
                "cull_rejects": [
                    {"episode": 1, "notes": [1], "failed": [2], "foreign": []},
                    {"episode": 2, "notes": [], "failed": [], "foreign": []},
                ],
            }
        ),
        pack_alias=1,
...
@pytest.mark.parametrize(
    ...
    (
        ...
        [{"episode": 1, "notes": [99], "failed": [], "foreign": []}],
        # an episode this pack does not have
        [{"episode": 7, "notes": [1], "failed": [], "foreign": []}],
        # the same episode answered twice
        [
            {"episode": 1, "notes": [1], "failed": [], "foreign": []},
            {"episode": 1, "notes": [2], "failed": [], "foreign": []},
        ],
        # a boolean is not a tile alias
        [{"episode": 1, "notes": [True], "failed": [], "foreign": []}],
        # an unexpected key
        ...
        json.dumps(
            {
                "schema_version": "episode-scan-v4",
                "pack": 1,
                "cull_rejects": [{"episode": 1, "notes": [1], "failed": [2], "foreign": []}],
            }
        ),
        pack_alias=1,
        ...
        json.dumps(
            {
                ...
                "cull_rejects": [
                    {"episode": 1, "notes": [1], "failed": [], "foreign": []},
                    {"episode": 2, "notes": [2, 3], "failed": [], "foreign": []},
                ],
            }
        ),
        pack_alias=1,
        ...
        json.dumps(
            {
                ...
                "pack": 1,
                "cull_rejects": [
                    {"episode": 1, "notes": [1], "failed": [2], "foreign": [], "ordinary": [3]},
                ],
            }
        ),
        pack_alias=1,
        ...
        json.dumps(
            {
                ...
                "cull_rejects": [
                    ...
                    {"episode": 2, "notes": [], "failed": [], "foreign": [], "ordinary": [2, 3]},
                ],
            }
        ),
        pack_alias=1,
        ...
        json.dumps(
            {
                ...
                "pack": 1,
                "cull_rejects": [
                    {"episode": 1, "notes": [3], "failed": [], "foreign": [], "ordinary": []},
                    {"episode": 2, "notes": [3], "failed": [], "foreign": [], "ordinary": []},
                ],
            }
        ),
        pack_alias=1,
        ...
        json.dumps(
            {
                ...
                "pack": 1,
                "cull_rejects": [
                    {"episode": 1, "notes": [1], "failed": [2], "foreign": [], "ordinary": []},
                    {"episode": 2, "notes": [], "failed": [1], "foreign": [], "ordinary": []},
                ],
            }
        ),
        pack_alias=1,
...
def test_foreign_media_is_a_bucket_of_its_own() -> None:
    ...
    assert "foreign" in CULL_SCOPE_WIRE_KEYS
