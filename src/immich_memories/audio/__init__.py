...
_SUBMODULE_MAP = {
    ...
    "mix_audio_with_stem_ducking": "immich_memories.audio.mixer_helpers",
    "MoodAnalyzer": "immich_memories.audio.mood_analyzer",
    "OllamaMoodAnalyzer": "immich_memories.audio.mood_analyzer_backends",
    "OpenAICompatibleMoodAnalyzer": "immich_memories.audio.mood_analyzer_backends",
    "VideoMood": "immich_memories.audio.mood_analyzer",
    "get_mood_analyzer": "immich_memories.audio.mood_analyzer_backends",
    "ClipMood": "immich_memories.audio.music_generator_models",
    "GeneratedMusic": "immich_memories.audio.music_generator_models",
    "MusicGenClient": "immich_memories.audio.music_generator_client",
    "MusicGenClientConfig": "immich_memories.audio.music_generator_client",
    "MusicGenerationResult": "immich_memories.audio.music_generator_models",
    "MusicStems": "immich_memories.audio.music_generator_models",
