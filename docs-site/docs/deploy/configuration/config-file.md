...
# ── The editor's model (any OpenAI-compatible endpoint) ───
# Tested against Qwen3.6-27B and Qwen3.6-35B-A3B. What it
# reads is prepared per Configuration → Editorial annotation setup.
llm:
