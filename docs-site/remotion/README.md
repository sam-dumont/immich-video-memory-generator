...
docs: `library` → `tests/e2e/fixtures/library` (the CC0 fixture library, 137 photos, credits in `CREDITS.md` there; `make demo-fixture` exports the cut and the pool page into `src/fixture.ts`) and
