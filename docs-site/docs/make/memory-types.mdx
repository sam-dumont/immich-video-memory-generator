...
and those are the ones worth reading about. Every type works with no model at all: the default
...
Five earlier birthdays are reached, each ±1 day, for the "look how small you were" cutaways. Most of
...
[`discover-days`](./cli/prepare.md) walks the library a month at a time. With no model, a day is
...
- A month or year gets a light polish on top of the no-model draft. What that polish does and costs
