"""Year dividers name the year changes in a cut, never the year it opens in.

The first change is dropped: a memory running continuously through its years
opens on a title card that already names the one it starts in, so a card there
would say it twice.
"""
...
def test_a_continuous_memory_opens_without_a_card() -> None:
    """A year in review that runs 2025 into 2026 is titled after the year it opens in."""
