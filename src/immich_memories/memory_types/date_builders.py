...
def build_special_day(
    ...
    catalogued day is a birth that ran 42.5 continuous hours across two dates,
    and scoping it to the date it began on stopped it at midnight with a
    quarter of its 379 pictures on the other side.
