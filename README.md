...
<p align="center">
  ...
  <br/>
  <sub><a href="https://sam-dumont.github.io/immich-video-memory-generator/docs/welcome/overview">▶ Watch the 60-second demo</a> · <a href="https://sam-dumont.github.io/immich-video-memory-generator/docs/create/first-memory">Make your first memory</a> · <a href="https://sam-dumont.github.io/immich-video-memory-generator/">Full documentation</a></sub>
</p>
...
| **Rules plus classifiers** (`tier: no_captions`) | Same box, plus about 500 MB of pinned ONNX models fetched with one command | The sensitive-content and document detectors, so the family-viewing gate has evidence. First pass over 10,793 pictures on a Celeron: 3 h 41 min, then banked |
...
The compose file publishes port 8080 on localhost only, and authentication is off by default. The app holds an API key to your whole library, so turn on [authentication](https://sam-dumont.github.io/immich-video-memory-generator/docs/deploy/configuration/authentication) before you expose the port. Immich v2 and v3 are detected at runtime.
