...
Wire up Ollama for LLM-powered mood analysis:
...
Use the [External Secrets Operator](https://external-secrets.io/) instead of storing API keys in Terraform state:
