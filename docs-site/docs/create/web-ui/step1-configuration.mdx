...
The presets also drive the output filename and title screen. A Multi-Person preset with Riley and Bob for March 2025 produces `riley_bob_march_2025_memories.mp4` with "Riley & Bob" as the title subtitle.
