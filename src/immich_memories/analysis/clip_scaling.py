"""Clip scaling and temporal deduplication utilities.

Extracted from clip_refinement.py for maintainability.
Provides duration scaling and temporal cluster deduplication for clip selections.
"""
