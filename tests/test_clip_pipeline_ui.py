...
def test_selection_uses_the_persisted_timeline_content_budget() -> None:
    ...
    pipeline_config = _build_pipeline_config(state)
...
def test_pipeline_summary_distinguishes_eligible_and_planned_counts() -> None:
    result = {
        "stats": {
            "eligible_count": 61,
            "planned_count": 30,
    ...
    assert _pipeline_summary_counts(result) == (61, 30)
