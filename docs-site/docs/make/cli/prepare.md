...
[the inference service](../../better/inference.md) the heads and detectors can
...
[the thin model layer](../../being-rewritten/pipeline.md) needs to run at all.
...
read [Network and privacy](../../run/privacy.md#the-two-picture-seats)
